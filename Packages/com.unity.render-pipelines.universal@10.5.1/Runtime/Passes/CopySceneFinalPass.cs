...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class CopySceneFinalPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.SetGlobalTexture("_SourceTex", cameraData.renderer.cameraColorTarget);

            //cmd.Blit(m_Source.Identifier(), /*BlitDstDiscardContent(cmd, m_Destination)*/ m_Destination.Identifier(), blitMaterial);
            cmd.Blit(cameraData.renderer.cameraColorTarget, cameraData.renderer.cameraColorTarget, blitMaterial);
