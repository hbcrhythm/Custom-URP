        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (lastCameraInTheStack)
            {
                ...
                if (applyPostProcessing)
                {
                    ...
                    m_PostProcessPass.Setup(cameraTargetDescriptor, m_ActiveCameraColorAttachment, destination, m_ActiveCameraDepthAttachment, m_ColorGradingLut, false, doSRGBConvertion);
                ...
                {
                    if (m_SplitUICameraAndSceneCameraRenderer && cameraData.camera.tag.Contains("UICamera"))
                    {
